...
urlpatterns = [
  # Admin URLs
  url('/admin/items/add/', view_func=views.admin.admin_panel_items_add, name='items_admin_add', methods=['GET', 'POST']),
  url('/admin/items/edit/', view_func=views.admin.admin_panel_items_edit, name='items_admin_edit'),
