...
export default function() {
  return (
    <Saylua title="Site Credits">
      ...
      <p>
        The world of Saylua was brought to life through the beautiful environment
        illustrations of <a href="http://lyraina.com">Lyraina</a>.
      </p>
      <p>
        The logo for Saylua was created by <a href="http://irianwhitefox.deviantart.com/">
        IrianWhitefox</a>.
      </p>
      <p>
      ...
      <p>
        Much of Saylua's lore was expanded upon through writing contributions from
        <a href="http://theartsyaxolotl.com/">ArtsyAxolotl</a>.
      </p>
      <p>
        And a special thanks to the early members of the project who helped
